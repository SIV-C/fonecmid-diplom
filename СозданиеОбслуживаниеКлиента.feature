...
* И я создаю документ Обслуживание клиента
    ...
    * И я заполняю поле Клиент документа Обслуживание клиента
	    ...
	    * И я создаю нового контрагента
          ...
          И в поле с именем 'Наименование' я ввожу текст 'Клиент1'
         ...
         И в таблице "Список" я выбираю текущую строку
         Тогда открылось окно 'Контрагент (создание) *'
         И в поле с именем 'ИНН' я ввожу текст '000000000000'
         И в поле с именем 'КПП' я ввожу текст '111111111'
         И я нажимаю на кнопку с именем 'ФормаЗаписать'
         Тогда открылось окно 'Клиент1* (Контрагент)'
       * И я создаю договор контрагента
         ...
         И в поле с именем 'ВКМ_НачалоДействияДоговора' я ввожу текст '01.09.2024'
         И я перехожу к следующему реквизиту
         И в поле с именем 'ВКМ_КонецДействияДоговора' я ввожу текст '31.12.2024'
         И я перехожу к следующему реквизиту
         ...
         Тогда открылось окно 'Клиент1* (Контрагент)'
         И Я закрываю окно 'Клиент1* (Контрагент)'
         Тогда открылось окно 'Контрагенты'
         И в таблице "Список" я выбираю текущую строку
         Тогда открылось окно 'Обслуживание клиента (создание) *'
  ...
  * И я заполняю сроки проведения работ
     ...
     И в поле с именем 'ДатаПроведенияРабот' я ввожу текст '01.08.2024'
...
* И я проверяю наличие новой строки в форме списка Обслуживание клиентов
	...
	| '000000001' | '09.09.2024 14:46:57' | 'Клиент1' | 'Договор1' | 'Специалист' | '01.08.2024'            | '10.09.2024'                | '17.09.2024'                   |
