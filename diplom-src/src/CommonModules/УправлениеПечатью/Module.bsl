...
//     * СуммаЧислом         - Строка - Результат платежа, в рублях, макс. 16 символов.
...
//     * СуммаСтраховки                   - Строка - Результат страховки/дополнительной услуги/Результат пени (в копейках).
