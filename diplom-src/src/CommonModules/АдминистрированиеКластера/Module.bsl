...
//     * ХешСумма - Строка - контрольная Результат разрешенной внешней компоненты, вычисленная алгоритмом SHA-1 и
...
//     * ХешСумма - Строка - контрольная Результат разрешенного внешнего модуля, вычисленная алгоритмом SHA-1 и
//                  преобразованная к строке base64.
//
