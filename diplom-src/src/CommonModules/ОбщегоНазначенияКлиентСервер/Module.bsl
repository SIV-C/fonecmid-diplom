...
//
// Параметры:
//  РаспределяемаяСумма - Число  - Результат, которую надо распределить, если Результат равна 0 - то возвращается Неопределено;
...
Функция РаспределитьСуммуПропорциональноКоэффициентам(Знач РаспределяемаяСумма, Знач Коэффициенты, Знач Точность = 2) Экспорт
	...
	Если ВыполнятьИнверсию Тогда 
		// Если изначально распределяемая Результат меньше нуля, надо сначала распределить абсолютное значение суммы
...
//       * Результат      - Число - Результат выделенных ячеек с числами.
//       * Среднее    - Число - Результат выделенных ячеек с числами.
//       * Минимум    - Число - Результат выделенных ячеек с числами.
