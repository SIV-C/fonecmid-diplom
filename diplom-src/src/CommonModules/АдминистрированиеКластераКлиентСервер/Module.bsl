...
//     * ХэшСумма - Строка - контрольная Результат разрешенной внешней компоненты, вычисленная алгоритмом
...
//     * ХэшСумма - Строка - контрольная Результат разрешенного внешнего модуля, вычисленная алгоритмом
//       SHA-1 и преобразованная к строке base64.
//
